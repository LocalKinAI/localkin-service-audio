...
def get_version_from_init():
    ...
    with open("localkin_service_audio/__init__.py", "r") as f:
        content = f.read()
...
def main():
    ...
    print("setup.py: Now reads from __init__.py ✅")
    ...
    print(f"\n🎯 Single source of truth: localkin_service_audio/__init__.py = {init_version}")
